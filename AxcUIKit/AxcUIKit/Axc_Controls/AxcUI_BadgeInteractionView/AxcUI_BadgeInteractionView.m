...
@interface AxcUI_BadgeInteractionView () {
...
@implementation AxcUI_BadgeInteractionView
...
- (void)setup {
    ...
    //爆炸效果
    UIImage* image0 = [UIImage AxcUI_axcUIBoundleImageName:@"AxcUI_BadgeInteractionView_bomb0"];
    UIImage* image1 = [UIImage AxcUI_axcUIBoundleImageName:@"AxcUI_BadgeInteractionView_bomb1"];
    UIImage* image2 = [UIImage AxcUI_axcUIBoundleImageName:@"AxcUI_BadgeInteractionView_bomb2"];
